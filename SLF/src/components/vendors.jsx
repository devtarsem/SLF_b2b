...
function Vendors(){
    ...
    return(
        <div className='vendors flex flex-dir gap16'>

            {AuthNeeded &&
                <Auth/>
            }

            <h2 className='resHead'>vendors</h2>
            <div className='flex flex-3 gap16'>
                <Link to='/dashboard/add-vendors' className='LinkInc link flex flex-dir gap8 flex-2'>
                ...
                <Link to='/dashboard/manage-vendors' className='LinkInc link flex flex-dir gap8 flex-2'>
